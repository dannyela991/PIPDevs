...
<!--  content -->
<main>
    <section class="list-projects archives">
        <div class="container">
            ...
            <div class="flex-container">
                ...
                <div class="content">
                    ...
                    <div class="search-homenagens">
                        <form class="form-homenagens" action="">
                            <input type="text" placeholder="Pesquisar por projeto..." name="search">
                    ...
                    <div class="content-archives">
                        ...
                        <div class="card-project">
                            <div class="title-project flex-container">
                                ...
                                <div class="title">                                        
                                    <a href="project-single.php"><h4>T&D SUSTENTÁVEL</h4></a>
                                    <p class="eixo">Biodiversidade, Bioeconomia, Tecnologias Verdes e Indústria Sustentável</p>
                                </div>
                            </div>
                            <div class="description-project">
                                <p class="city-uf">TRÊS COROAS | RS</p>
                                <p>Segundo o Grupo de Recursos da Água da ONU, teremos um déficit hídrico global de 40% até 2030. Trabalhamos combatendo o desperdício de água potável nos grandes consumidores urbanos e assim evitamos a escassez hídrica.</p>
                                <div class="img-ods">
                                    <ul>
                        ...
                        <div class="card-project">
                            <div class="title-project flex-container">
                                ...
                                <div class="title">                                        
                                    <a href="project-single.php"><h4>ECOFUNDING</h4></a>
                                    <p class="eixo">Finanças</p>
                                </div>
                            </div>
                            <div class="description-project">
                                <p class="city-uf">TRÊS COROAS | RS</p>
                                <p>Resolvemos a escassez de recursos financeiros para pequenos e médios projetos com impacto socioambiental.</p>
                                <div class="img-ods">
                                    <ul>
                                        <li><img src="app/assets/images/img-ods/01.png" alt=""/></li>
                                        <li><img src="app/assets/images/img-ods/04.png" alt=""/></li>
                        ...
                        <div class="card-project">
                            <div class="title-project flex-container">
                                ...
                                <div class="title">                                        
                                    <a href="project-single.php"><h4>DENGO</h4></a>
                                    <p class="eixo">Biodiversidade, Bioeconomia, Tecnologias Verdes e Indústria Sustentável</p>
                                </div>
                            </div>
                            <div class="description-project">
                                <p class="city-uf">TRÊS COROAS | RS</p>
                                <p>Os problemas sociais e ambientais que buscamos endereçar:(1) Renda Justa; (2) Alimentação Saudável; (3) Consumo Consciente; (4) Preservação da Floresta e (5) Diversidade e Inclusão</p>
                                <div class="img-ods">
                                    <ul>
                                        <li><img src="app/assets/images/img-ods/01.png" alt=""/></li>
                                        <li><img src="app/assets/images/img-ods/04.png" alt=""/></li>
                ...
                <div class="sidebar">
                    <div class="list-category">
                        <h2><a href="podcast.php">Ecossistema de Impactos</a></h2>
                        <ul>
                            <!-- <li><a href="trend-news.php">Investimento</a></li> -->
                            <!-- <li><a href="medias.php">Setor Público</a></li> -->
                            <li><a href="projetos-dinamizadores.php">Dinamizadores</a></li>
                            <li><a href="projetos-comunidades.php">Comunidades</a></li>
                            <li><a href="projetos-grandes-empresas.php">Grandes Empresas</a></li>
                        </ul>
                    </div>
                    <div class="list-category">
                        <h2><a href="podcast.php">Negócio de Impacto</a></h2>
                        <ul>
                            <li><a href="projetos-cidadania.php">Cidadania</a></li>
                            <li><a href="projetos-cidades.php">Cidades</a></li>
                            <li><a href="projetos-educacao.php">Educação</a></li>
                            <li><a href="projetos-saude.php">Saúde</a></li>
                            <li><a href="projetos-financas.php">Finanças</a></li>
                            <li><a href="projetos-tecnologia-verde.php">Tecnologia Verde</a></li>
                        </ul>
                    </div>
