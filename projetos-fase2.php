            ...
            <div class="flex-container">
                ...
                <div class="content">
                    <div class="page-header">
                        <h2>Negócios de Impacto <span>Cidadania</span></h2>
                        <h1>Finalistas PIP 2022</h1>
                    </div>
                ...
                <div class="sidebar">
                    ...
                    <div class="list-category">
                        <h2>Negócio de Impacto</h2>
                        <ul>
                            <li><a href="trend-news.php">Cidadania</a></li>
                            <li><a href="medias.php">Cidades</a></li>
                            <li><a href="podcast.php">Educação</a></li>
                            <li><a href="podcast.php">Saúde</a></li>
                            <li><a href="podcast.php">Finanças</a></li>
                            <li><a href="podcast.php">Tecnologia Verde</a></li>
                        </ul>
                    </div>
