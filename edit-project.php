            ...
            <div class="flex-container">
                <div class="content">                    
                    <div class="tab">                        
                        ...
                        <button class="tablink" onclick="openPage('eixos-data')">Eixo Temático</button>   
                        <button class="tablink" onclick="openPage('ods-data')">ODS's</button>   
                    </div>

                    <!-- tab Empresa Negócios de impacto -->
                    <div id="buss-data" class="tabcontent">
                        ...
                        <div class="form-group">
                            ...
                            <label for="eixo">                            
                                <input type="radio" checked name="eixo" value="Operação">
                    ...
                    <!-- tab Empresa Ecossistema de impacto -->
                    <div id="perfil-data" class="tabcontent">
                        <h3>Perfil Negócio</h3>
                        <!-- PERFIL SUBCATEGORIA -->
                        <fieldset class="step">
                            <div class="form-group">
                            ...
                            <div class="flex-form">             
                                ...
                                <div class="read-more">
                                    <a href="#" class="btn bg-green">Próximo</a>
                                </div>               
                            </div>
                        </fieldset>
                    ...
                    <!-- tab Empresa Ecossistema de impacto -->
                    <div id="eco-data" class="tabcontent">
                        <h3>Dados do Negócio</h3>
                        <div class="form-group">
                            <label for="razao_Social">Razão Social</label>
                            <input type="text" name="razao_Social" id="razao_Social">
                    ...
                    <div id="eixos-data" class="tabcontent">
                        <h3>Eixo Temático</h3>
                        <fieldset class="step">
                            <div class="form-group">
                                ...
                                <label for="eixo">                            
                                    <input type="radio" checked name="eixo" value="Eixo Temático - Educação, cultura, economia criativa e tecnologia da informação">
                        ...
                        <fieldset class="step">
                            ...
                            <div class="form-group">
                                ...
                                <label for="">                            
                                    <input type="checkbox" checked name="" value="Soluções e tecnologias de educação para o ensino fundamental II">
                                ...
                                <label for="">                            
                                    <input type="checkbox" checked name="" value="Soluções relacionadas à educação técnica e  profissional">
                    ...
                    <div id="ods-data" class="tabcontent">                        
                        <h3>Alterar ODS's do meu Projeto</h3>
                        <!-- objetivo 01 - Erradicação da pobreza -->
                        <div class="form-group">
                            <label for="">                            
                                <input type="checkbox" checked name="" value="Objetivo 1">
