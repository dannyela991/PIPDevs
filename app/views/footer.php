<footer>
        ...
        <div class="container links-footer flex-container">
    ...
    <script type="text/javascript" src="app/assets/slick/slick.min.js"></script>
    <script type="text/javascript" src="app/assets/script.js"></script>
</body>
</html>